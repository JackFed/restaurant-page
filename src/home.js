...
export default function makeHomePage() {
    ...
    title.textContent = "Fork 'N Skewer";
...
function makeInfoItem(item) {
    ...
    p1.textContent = "Welcome to the World's First Chess and Kebab Shop! Discover a unique"+
                " fusion of culinary delight and strategic mastery at our one-of-a-kind "+
                "establishment.";
    const p2 = document.createElement('p');
    p2.textContent = " Whether you're a grandmaster or a novice, our cozy ambiance invites you to "+
    ...
    p3.textContent = "From spicy jerk lamb to savory teriyaki chicken, our dishes promise to tantalize" +
    ...
    p4.textContent = "Come for the chess, stay for the kebabs, and enjoy a harmonious blend of flavors and fun."
...
function makeLessonItem(item) {
    ...
    const p1 = document.createElement('p');
    p1.textContent = "Join on weeknights for a free kebab with any purchase of lessons.";
    const p2 = document.createElement('p');
